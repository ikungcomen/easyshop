    ...
    <div class="slider-area">
			...
			<div class="block-slider block-slider4">
				<ul class="" id="bxslider-home4">
					...
					<li><img src="<?php echo base_url();?>img/h4-slide2.png" alt="Slide">
						<div class="caption-group">
							<h2 class="caption title">
					...
					<li><img src="<?php echo base_url();?>img/h4-slide3.png" alt="Slide">
						<div class="caption-group">
							<h2 class="caption title">
					...
					<li><img src="<?php echo base_url();?>img/h4-slide4.png" alt="Slide">
						<div class="caption-group">
						  <h2 class="caption title">
								Apple <span class="primary">Store <strong>Ipod</strong></span>
							</h2>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    ...
                                    <div class="product-hover">
                                        <a href="<?php echo base_url(); ?>index.php/frontend/cartController/add_cart_byProduct/2/B" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                ...
                <div class="col-md-12">
                    <div class="brand-wrapper">
                        <div class="brand-list">
                            <img  alt="smile" id="imgSmile" src="<?php echo base_url();?>img/brand1.png" alt="">
